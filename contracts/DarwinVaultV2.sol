...
///         automatically. Performance fees are taken above a high water mark.
contract DarwinVaultV2 is ERC4626, Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        ...
        ERC4626(_asset)
        ERC20("DarwinFi Vault USDC", "dvUSDC")
        Ownable(_owner)
    {
