...
/**
 * DarwinVaultV2 ABI - extracted from compiled Hardhat artifact
 * contracts/DarwinVaultV2.sol - ERC4626 vault with agent borrowing
 */
...
/**
 * Minimal USDC ERC20 ABI for balance/approve/allowance
 */
...
export { VAULT_ADDRESS, USDC_ADDRESS };
