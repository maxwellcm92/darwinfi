...
async function main() {
  ...
  console.log("Deploying DarwinVaultV3 with account:", deployer.address);
  ...
  console.log("DarwinVaultV3 deployed to:", vaultAddress);

  console.log("\nAdd to .env:");
  console.log(`DARWIN_VAULT_V3_ADDRESS=${vaultAddress}`);
}
