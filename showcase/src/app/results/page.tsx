              ...
              <div key={e.cycle} className="relative pl-8">
                ...
                <div className="p-3 rounded-lg bg-darwin-bg/50 border border-darwin-border/30">
                  ...
                  <div className="flex flex-wrap gap-2 mt-1.5">
                    {e.promoted && (
                      <span className="text-sm font-mono px-1.5 py-0.5 rounded bg-darwin-success/10 text-darwin-success">
                        + {e.promoted}
                      </span>
                    )}
                    {e.eliminated && (
                      <span className="text-sm font-mono px-1.5 py-0.5 rounded bg-darwin-danger/10 text-darwin-danger">
                        - {e.eliminated}
                      </span>
                    )}
                  </div>
    ...
    <div className="darwin-card">
      ...
      {data.consensusSignal && (
        <div className="mb-4 p-3 rounded-lg bg-darwin-purple/10 border border-darwin-purple/20">
          <span className="text-sm font-mono text-darwin-purple-dim">
            Consensus
          </span>
      ...
      <div className="space-y-2">
        {data.predictions!.map((p, i) => (
          ...
          >
            <div>
              <p className="text-base font-medium text-darwin-text-bright">
                {p.department}
              </p>
            ...
            <div className="text-right">
              ...
              <span className="text-sm font-mono text-darwin-text-dim mt-0.5">
  ...
  return (
    <div className="flex items-center gap-3">
      <div className="relative flex items-center gap-2">
        ...
        <span className="text-sm font-mono text-darwin-success uppercase tracking-wider">
          Live
        </span>
      </div>
