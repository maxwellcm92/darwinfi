          ...
          : trades.map((t) => (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-darwin-text-bright truncate">
                    {t.token}
                  </p>
                ...
                <div className="text-right shrink-0">
                  <p className="text-sm font-mono text-darwin-text">
                    ${t.amount.toFixed(2)}
                  </p>
                  {t.pnl != null && (
                    <p
                ...
                <span className="text-xs text-darwin-text-dim font-mono shrink-0">
